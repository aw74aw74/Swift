...
final class GroupsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // Выводим список групп в консоль только один раз при первом переходе на экран
    ...
    @objc private func applyTheme() {
        ...
        descriptionLabel.textColor = themeColors.secondaryTextColor // Используем secondary для описания
        tableView.backgroundColor = themeColors.secondaryBackgroundColor // или backgroundColor
        tableView.separatorColor = themeColors.accentColor.withAlphaComponent(0.5)
        
        // Обновление profileImageView
        profileImageView.backgroundColor = themeColors.secondaryBackgroundColor // или cellBackgroundColor
        profileImageView.layer.borderColor = themeColors.accentColor.withAlphaComponent(0.7).cgColor
...
extension GroupsViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let themeColors = ThemeManager.shared.getCurrentThemeColors()
        cell.backgroundColor = themeColors.cellBackgroundColor
        cell.textLabel?.textColor = themeColors.textColor
        ...
        // Для выбранной ячейки можно задать selectedBackgroundView с цветом из темы
        let selectedView = UIView()
        selectedView.backgroundColor = themeColors.accentColor.withAlphaComponent(0.2)
